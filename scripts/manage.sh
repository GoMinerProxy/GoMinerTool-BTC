...
install(){
    ...
    wget https://raw.githubusercontent.com/GoMinerProxy/GoMinerTool-BTC/main/scripts/run.sh -O /root/go_miner_proxy/run.sh --no-check-certificate
    chmod 777 /root/gominertool-btc/run.sh
    wget https://raw.githubusercontent.com/GoMinerProxy/GoMinerTool-BTC/main/others/cert.tar.gz -O /root/gominertool-btc/cert.tar.gz --no-check-certificate
